...
from cgen.frontend.flow_sensitive_inference import FlowSensitiveInferencer, FLOW_INT, FLOW_FLOAT, FLOW_BOOL, TypeUnifier
...
class TestTypeUnifier:
    ...
    def test_basic_unification(self):
        ...
        from cgen.frontend.flow_sensitive_inference import FLOW_UNKNOWN
